...
<div class="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-10">
    <div class="w-full max-w-md">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-bold tracking-tight text-foreground mt-6">Daftar Akun Baru</h1>
            <p class="text-sm text-muted-foreground mt-1">Isi data diri Anda untuk mendaftar</p>
        </div>
        ...
        <form method="POST" action="<?= base_url('/auth/register'); ?>" class="space-y-4">
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="username" placeholder="Masukkan username" class="input pl-10 w-full" value="<?= old('username'); ?>" required>
                </div>
                <p class="text-destructive text-xs"><?= error('username'); ?></p>
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative">
                    ...
                    <input type="tel" name="phone" placeholder="Masukkan nomor telepon" class="input pl-10 w-full" value="<?= old('phone'); ?>" required>
                </div>
                <p class="text-destructive text-xs"><?= error('phone'); ?></p>
            </div>
            ...
            <!-- Confirm Password -->
            <div class="space-y-1.5">
                <label class="text-sm font-medium text-foreground">Konfirmasi Password</label>
                <div class="relative password-wrapper">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="h-4 w-4 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
                    ...
                    <input type="password" name="password_confirmation" placeholder="Masukkan ulang password" class="input pl-10 pr-10 w-full password-input" required>
                ...
                <p class="text-destructive text-xs"><?= error('password_confirmation'); ?></p>
            </div>
            <p class="text-xs text-muted-foreground">Gunakan minimal 8 karakter dengan kombinasi huruf dan angka</p>
            ...
            <p class="text-center text-sm text-muted-foreground">
                Sudah punya akun?
                <a href="<?= base_url('/auth/login'); ?>" class="text-primary font-medium hover:underline">Masuk sekarang</a>
            </p>
        </form>
    </div>
</div>
...
<div class="hidden lg:block lg:w-1/2 bg-linear-to-br from-primary/10 via-primary/5 to-transparent border-l border-border">
    <div class="h-full flex flex-col items-center justify-center p-10 text-center">
        ...
        <h2 class="text-2xl font-bold tracking-tight text-foreground">Bergabung Sekarang</h2>
        <p class="text-sm text-muted-foreground mt-1">Jadi bagian dari sistem pengaduan yang transparan</p>
