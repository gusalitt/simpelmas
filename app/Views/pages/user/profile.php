...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-6">
        ...
        <div class="bg-card border border-border rounded-3xl shadow-sm overflow-hidden">
            ...
            <form action="<?= base_url('/profile'); ?>" method="post" enctype="multipart/form-data" class="p-6 space-y-5">
                <!-- Avatar Section -->
        ...
        <div class="bg-card border border-border rounded-3xl shadow-sm overflow-hidden">
            ...
            <form action="<?= base_url('/profile/update-password'); ?>" method="post" class="p-6 space-y-5">
                <div class="space-y-1.5">
